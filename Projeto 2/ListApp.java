...
class ListFrame extends JFrame {
    ...
    try {
        ...
        buts.add(new Button(4, new Triangulo(25,185,30,30,Color.black, Color.black)));
                    ...
                    focus = null;
                     ...
                     if(focus_but != null && !((evt.getX() >= 20 && evt.getX() <= 60 && evt.getY() >= 65 && evt.getY() <= 185))) {
		                if (focus_but.getIdx() == 1) {
							...
							figs.add(new Triangulo(evt.getX(),evt.getY(), rand.nextInt(50),rand.nextInt(50),contorno, fill));
						}
						repaint();
					}
        ...
        this.addKeyListener (
                    ...
                    if (evt.getKeyChar() == 'r') {
                       ...
                       if (evt.getKeyChar() == 'a') {
                        figs.add(new Arc(x, y,w, h,contorno, fill, anguloInicial, anguloArc));
                         ...
                         figs.add(new Triangulo(x, y, w, h, contorno, fill));
                    }
			...
			if (evt.getKeyCode() == 40) {
				for(Figure fig: figs){
					...
					//muda a cor de fundo das imagens
                    ...
                    if(evt.getKeyChar() == '5' && focus!=null ){
					   ...
					   //Muda a cor do contorno das imagens
                    if(evt.getKeyChar() == '6' && focus!=null ){
						focus.contorno=Color.green;
                       }
                    if(evt.getKeyChar() == '7' && focus!=null ){
						focus.contorno=Color.red;
                       }
                    if(evt.getKeyChar() == '8' && focus!=null ){
						focus.contorno=Color.blue;
                       }
                    if(evt.getKeyChar() == '9' && focus!=null ){
						focus.contorno=Color.pink;
		               }
			        if(evt.getKeyChar() == '0' && focus!=null ){
						focus.contorno=Color.yellow;
		       }
			repaint();
		}
	    }
